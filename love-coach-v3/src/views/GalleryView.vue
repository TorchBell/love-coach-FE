...
// --- Gallery Images with Sidecut Unlock System ---
const galleryImages = ref([
  { id: 1, title: '첫 식단 기록', image: CHAR_IMAGES.toma, gif: CHAR_IMAGES.tomai, sidecut: CHAR_IMAGES.tomahi, character: 'toma', unlocked: true, unlockCost: 10 },
  { id: 2, title: '건강한 아침', image: CHAR_IMAGES.tomai, gif: CHAR_IMAGES.tomahi, sidecut: CHAR_IMAGES.toma, character: 'toma', unlocked: false, unlockCost: 15 },
  { id: 3, title: '첫 근력 운동', image: CHAR_IMAGES.belle, gif: CHAR_IMAGES.belleMuscle, sidecut: CHAR_IMAGES.belleNormal, character: 'belle', unlocked: true, unlockCost: 10 },
  { id: 4, title: '스쿼트 마스터', image: CHAR_IMAGES.belleNormal, gif: CHAR_IMAGES.belle, sidecut: CHAR_IMAGES.belleMuscle, character: 'belle', unlocked: false, unlockCost: 20 },
  { id: 5, title: '첫 러닝', image: CHAR_IMAGES.chie, gif: CHAR_IMAGES.chieRun, sidecut: CHAR_IMAGES.chieNormal, character: 'chie', unlocked: true, unlockCost: 10 },
  { id: 6, title: '5km 완주', image: CHAR_IMAGES.chieNormal, gif: CHAR_IMAGES.chie, sidecut: CHAR_IMAGES.chieRun, character: 'chie', unlocked: false, unlockCost: 25 },
  { id: 7, title: '토마의 응원', image: CHAR_IMAGES.tomahi, gif: CHAR_IMAGES.toma, sidecut: CHAR_IMAGES.tomai, character: 'toma', unlocked: false, unlockCost: 30 },
  { id: 8, title: '벨과 득근', image: CHAR_IMAGES.belleMuscle, gif: CHAR_IMAGES.belle, sidecut: CHAR_IMAGES.belleNormal, character: 'belle', unlocked: true, unlockCost: 15 },
])
...
const handleModalUnlock = (image) => {
  const userTokens = 100 // Mock
